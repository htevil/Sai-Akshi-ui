...
export default function Plans() {
  ...
  return (
    <div className="plans" id="Plans" style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center", paddingBottom: "20px", backgroundColor: "#D9EDBF" }}>
      <div style={{ width: "100%", maxWidth: "1560px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", }}>
        <h1 className="heading" id='h3' style={{ fontSize: "32px", color: "#FF9800"}}>Our Plans</h1>
        <div className="slider" style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "20px", marginBottom: "20px" }} >
          {getCards().map((image, index) => (
            <div className='card' key={index} style={{ width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", gap: "5px" }}>
              <img src={image.src} alt={`plan_${image.src}`} style={{ width: "100%", maxWidth: "440px", borderRadius: "8px", border: "3.5px solid #2C7865"}}/>
              <span style={{ width: "30%", display: "flex", justifyContent: "center", alignItems: "center", padding: "6px 0px", backgroundColor: "#90D26D", borderRadius: "4px", color: "#2C7865", fontSize: "18px", fontWeight: "600"}}>{image.name}</span>
            </div>
          ))}
        </div>

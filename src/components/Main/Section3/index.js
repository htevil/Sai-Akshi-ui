...
export default function Plans() {
  ...
  return (
    <div className="plans" id="Plans" style={{ width: "100%", paddingBottom: "20px", backgroundColor: "#D9EDBF" }}>
      <div style={{ width: "100%", maxWidth: "1560px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", }}>
        ...
        <div className="slider" style={{ display: "flex", justifyContent: "center", alignItems: "center", gap: "20px", marginBottom: "40px", padding:"0px 20px" }} >

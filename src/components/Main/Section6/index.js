...
export default function Section6() {
    return (
        <div id="About-Developer" style={{ width: "100%", maxWidth: "1560px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", backgroundColor:"#D9EDBF" }}>
            <h1 className="s6-heading" style={{ fontSize: "32px", color:"#FF9800"}}>About Developer</h1>
            <div className="main_div" style={{ display: 'flex', flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "0px 200px" }}>

...
export default function Section6() {
    return (
        <div className="About-Developer" style={{ width: "100%", maxWidth: "1560px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", margin: "20px 0px" }}>
            <h1 className="s6-heading" style={{ fontSize: "28px", marginBottom: "20px" }}>About Developer</h1>
            <div className="main_div" style={{ display: 'flex', flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "20px 200px" }}>
                <img src={uvklogo} alt="no-uvklogo" style={{ width: "150px", marginBottom:"20px" }} />

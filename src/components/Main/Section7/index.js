...
export default function Section7() {
    return (
        <div id="Enquire-Now" style={{ width: "100%", height:"580px", maxWidth: "1560px", display: "flex", justifyContent: "center", alignItems: "center", gap: "20px",backgroundImage:`url(${bg})`,backgroundSize:"cover"}}>
            <iframe
                ...
                style={{ border: '0', width: "580px", height: "480px", borderRadius: "4px" }}
                allowFullScreen
                loading="lazy"
                referrerPolicy="no-referrer-when-downgrade"
                title="Sai Akshi Location Map"
            ></iframe>
            <div style={{ width:"34.31%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px", border: "2px solid #FF9800", padding: "20px 30px", borderRadius: "10px"}} >
                ...
                <form style={{ width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", gap: "12px", margin:"8px 0px"}}>
                    ...
                    <input type="button" name="submit" value="Submit" style={{padding:"10px 20px", border:"none", borderRadius:"5px", backgroundColor:"#FF9800"}} />
                </form>

    ...
    return (
        <div style={{ width: "100%", height: '800px', display: "flex", justifyContent: "center", alignItems: "center", backgroundColor: "#D9EDBF", backgroundImage: `url(${bg})`, backgroundSize: "cover" }}>
            <div id="Enquire-Now" style={{ width: "100%", height: "100%", maxWidth: "1560px", display: "flex", flexDirection: isLargerThan1024 ? "row" : "column", justifyContent: "center", alignItems: "center", gap: isLargerThan1024 ? "40px" : "20px", }}>
                ...
                <div className="down-part" style={{ width, maxWidth: "480px", height: "fit-content", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "12px", border: "2px solid #FF9800", padding: isLargerThan1024 ? "30px 20px" : "20px 10px", animation: "m2 linear", animationTimeline: "view()", animationRange: "entry 0%" }} >
                    ...
                    <form style={{ width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", gap: "10px", margin: "5px 10px", padding: isSmallThan768 ? "0px 10px" : "0px 20px" }}>

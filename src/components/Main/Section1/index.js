    ...
    return (
        <div className="view" id="Overview" style={{ width: "100%", height: "fit-content", maxWidth: "1560px", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", }}>
            <div className="top-part" style={{ animation: "h1 linear", animationTimeline: "view()", animationRange: "entry 0%" }}>
                <h1 className="heading" style={{ fontSize: isSmallThan768? "24px" : "32px" , color: "#FF9800", }} >
                    Project Overview
                </h1>
            </div>
            ...
            <div className="down-part" style={{ display: "flex", flexDirection: isLargerThan1024 ? "row" : "column", justifyContent: "center", alignItems: "center", gap:  isLargerThan1024 ? "20px": "20px", marginBottom: "20px"}}>
                ...
                <div className="main_right" style={{ width: isLargerThan1024 ? "35%" : "80%", height: "fit-content", backgroundColor: "#D9EDBF", padding: isSmallThan768? "0px 10px" : "20px 40px", borderRadius: "10px", animation: "m2 linear", animationTimeline: "view()", animationRange: "entry 0%" }}>

...
export default function Navbar() {
    return (
        <div className="navbar" style={{ width: "100%", height:"fit-content", position: "fixed", top: "0%", backgroundColor: "#D9EDBF",  display: "flex", justifyContent: "center", alignItems: "center"}}>
